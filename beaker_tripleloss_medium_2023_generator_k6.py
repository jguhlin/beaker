...
from biobeaker.utils import get_angles, positional_encodi
...
weights = np.load(
    ...
    "weights/wide_singlelayer_k6_23Apr2023_linear_nucleotide_model_magic_dims_16_epochs_96_loss_huber_bias_True.npy",
    allow_pickle=True,
)
